...
import { H1, Lg } from '../common/Typography';
  ...
  return (
    <div className="flex flex-col lg:flex-row justify-between items-center px-4">
      <div className="w-full text-center lg:text-left lg:px-0 l-4 md:pl-8 lg:pl-36">
        <H1 className="pb-6 text-white text-shadow-sm">
          MeeBot 미봇
        </H1>
        <Lg className="pb-6 text-white">
          ...
          <br className="hidden lg:block" />
          <br className="hidden lg:block" />
          <span className='text-[#1AEBB8] !font-bold'>실시간 스크립트</span>부터 <span className='text-[#1AEBB8] !font-bold'>발표 요약</span>,
          <br className="hidden lg:block" />
          <span className='text-[#1AEBB8] !font-bold'>맞춤형 질문 추천</span>까지
          <br className="hidden lg:block" />
          효율적인 발표 진행을 위한 기능을 제공합니다.
        </Lg>
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 pt-2 justify-center lg:justify-start z-10">
