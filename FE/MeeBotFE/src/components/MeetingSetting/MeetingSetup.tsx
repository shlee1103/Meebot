...
import { useOpenVidu } from "../../openVidu/hooks/useOpenVidu";
...
const MeetingSetup: React.FC<MeetingSetupProps> = ({ className }) => {
  const { myUserName, setMyUserName } = useOpenVidu();
          ...
          <div className='flex flex-col gap-4'>
            ...
            <div className="flex flex-col gap-4 w-full">
              <input
                ...
                `}
              />
              <p className="text-[#ACACAC] font-pretendard text-[10px] md:text-[12px] lg:text-[14px] text-left">
                * 사용자 이름은 화상 회의에서 다른 사용자에게 보여지는 이름과 동일합니다.
              </p>
            </div>
          </div>
