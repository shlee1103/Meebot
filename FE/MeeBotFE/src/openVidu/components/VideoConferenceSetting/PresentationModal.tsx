...
export const PresentationModal: React.FC<PresentationModalProps> = ({
  ...
  return (
    <div className={`fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[1002]
      ...
      <div className={`bg-gradient-to-b from-[#1C2135] to-[#171F2E] w-[650px] h-[85%]
        rounded-2xl flex flex-col shadow-2xl border border-[#2A3347]/30
        transition-all duration-300 ease-out
        ${mounted ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-8 scale-95'}`}>
        {/* Header */}
        <div className={`px-8 pt-8 pb-6 border-b border-[#2A3347]/30
        ...
        <div className={`flex-1 overflow-y-auto px-8 py-6 space-y-12 custom-scrollbar
          ...
          <section className="space-y-4">
            ...
            <div className="bg-[#171F2E]/50 border border-[#2A3347] rounded-xl overflow-hidden
          ...
          {/* 요약 */}
          <div className="bg-gradient-to-r from-[#1A2338] to-[#232D45] rounded-xl p-6 border border-[#2A3347]/30
        ...
        <div className={`px-8 py-4 border-t border-[#2A3347]/30 bg-[#171F2E]/50 backdrop-blur-sm
