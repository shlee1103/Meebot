...
const ControlBar: React.FC<ControlBarProps> = ({
  ...
  const { presentationTime, setPresentationTime, qnaTime, setQnATime, selectedSpeakers, presentersOrder, handleSpeakerSelect, handleSpeakerRemove, handleDragEnd, randomizeSpeakersOrder } =
      ...
      <div className="flex items-center justify-between px-4">
        ...
        <div className="flex-1 flex items-center justify-center gap-7 py-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <HandButton onHandClick={toggleHand} onArrowClick={toggleHandList} isHandActive={isHandRaised} isArrowActive={isOpenHandList} conferenceStatus={conferenceStatus}>
              <HandRaisedIcon />
            </HandButton>
        ...
        <div className="flex w-[350px] justify-end">
          {role === "admin" && (
            <div className="hidden lg:flex flex-row items-center gap-4">
              ...
              {presentersOrder.length > 0 && <ConferenceStatusButton conferenceStatus={conferenceStatus} changeConferenceStatus={changeConferenceStatus} />}
            </div>
          )}
        </div>
      </div>
